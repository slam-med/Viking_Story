 ...
 *
 */
package net.mcreator.vikingstory;
...
@Mod("viking_story")
public class VikingStoryMod {
	public static final Logger LOGGER = LogManager.getLogger(VikingStoryMod.class);
	public static final String MODID = "viking_story";
